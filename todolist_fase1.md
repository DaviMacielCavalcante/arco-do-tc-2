...
- [~] **Integração:** o pipeline reproduz o XMI-oráculo pelo harness da 0.3 — **mintest com 0 divergências** (`tests/datasets/`). O **Northwind** (onde as divergências fatais do #8 seriam exibidas) foi **adiado para a Fase 2**, que produz a tripla real. Parcial por decisão, não por lacuna do núcleo.
